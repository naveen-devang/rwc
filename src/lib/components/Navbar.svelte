...
<div class="mobile-menu-drawer" class:open={menuOpen}>
  <div class="mobile-menu-content">
    <div class="mobile-links">
      <a href="#home" onclick={() => menuOpen = false}>{t('nav.home')}</a>
      <a href="#about" onclick={() => menuOpen = false}>{t('nav.info')}</a>
      <a href="#brands" onclick={() => menuOpen = false}>{t('nav.brands')}</a>
      <a href="#products" onclick={() => menuOpen = false}>{t('nav.products')}</a>
      <a href="#contact" onclick={() => menuOpen = false}>{t('nav.contact')}</a>
    </div>

    <div class="mobile-actions">
      <span class="mobile-contact">{t('nav.general_enquiry')}</span>
      <button class="mobile-lang-btn" onclick={() => { langState.toggle(); menuOpen = false; }}>
        {langState.current === 'en' ? 'العربية' : 'English'}
      </button>
    </div>
  </div>
...
<style>
  ...
  nav.scrolled a, nav.scrolled .logo-text, nav.scrolled .contact {
  ...
  nav:not(.scrolled) a, nav:not(.scrolled) .logo-text, nav:not(.scrolled) .contact {
  ...
  nav.menu-is-open:not(.scrolled) .logo img {
  ...
  nav:not(.scrolled):not(.menu-is-open) .logo img {
  ...
  .mobile-menu-drawer.open .mobile-links a:nth-child(1) { transition-delay: 0.1s; }
  .mobile-menu-drawer.open .mobile-links a:nth-child(2) { transition-delay: 0.15s; }
  .mobile-menu-drawer.open .mobile-links a:nth-child(3) { transition-delay: 0.2s; }
  .mobile-menu-drawer.open .mobile-links a:nth-child(4) { transition-delay: 0.25s; }
  .mobile-menu-drawer.open .mobile-links a:nth-child(5) { transition-delay: 0.3s; }
